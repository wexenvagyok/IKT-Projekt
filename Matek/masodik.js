document.addEventListener('DOMContentLoaded', function() {
  window.masodikFeladat = function() {
    ...
    // Három oldal -> szögek koszinusz tétellel
    ...
    // Egy oldal + két szög -> law of sines egyszerűen (ha van a és A)
    ...
    // Két oldal + köztük lévő szög -> koszinusz tétel (például b,c és A köztük)
    ...
    // Ha nincs oldal, de két szög van -> arányos méretek (R=1)
    let note = '';
    ...
    // Csak a kiválasztott trig függvényt mutatjuk
