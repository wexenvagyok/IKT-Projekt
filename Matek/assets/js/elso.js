...
function elsoFeladat() {
    ...
    //OLDALAK
    if (aOldal != 0) {
        document.querySelectorAll('.eredmeny div')[0].innerHTML += `<p>a: ${aOldal}</p>`;
    }
    ...
    if(aOldal !=0 && bOldal !=0 && cOldal != 0){
        ...
        document.querySelector('.eredmeny').innerHTML += `<p>a: ${megoldas}</p>`;
        ...
        document.querySelector('.eredmeny').innerHTML += `<p>b: ${megoldas}</p>`;
